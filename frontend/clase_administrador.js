...
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/nuevoadmin');  //  Abre el link con al atributo nueva pelicula
...
try {
       ...
       var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/loginadmin');
...
try {
       ...
       var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/Eliminausuario');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
resolve(JSON.parse(xhr.responseText));
...
try {
       ...
       var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionaradministradores');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
resolve(JSON.parse(xhr.responseText));
