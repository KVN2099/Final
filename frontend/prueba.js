...
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/Nuevapelicula');  //  Abre el link con al atributo nueva pelicula
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/Modificapelicula');
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/Eliminapelicula');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
   resolve(JSON.parse(xhr.responseText));
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionartodos');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
   resolve(JSON.parse(xhr.responseText));
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionarporfecha');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
   resolve(JSON.parse(xhr.responseText));
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionarporid');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
   resolve(JSON.parse(xhr.responseText));
...
// Do the usual XHR stuff
 ...
 try {
          ...
          var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionarpornombre');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
if (xhr.status === 200) {
   resolve(JSON.parse(xhr.responseText));
...
try {
var xhr = new XMLHttpRequest();
xhr.open('POST', 'https://como-le-de-la-gana.herokuapp.com/api/seleccionapelicula');  //  Abre un link con el atributo seleccionar todos los documentos
xhr.setRequestHeader('Content-Type', 'application/json');  //  Formato JSON
xhr.onload = function() {
